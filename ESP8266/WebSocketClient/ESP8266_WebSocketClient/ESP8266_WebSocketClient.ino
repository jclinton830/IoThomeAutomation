...
const char* ssid     = "TP-LINK_F3DC"; //enter your ssid/ wi-fi(case sensitiv) router name - 2.4 Ghz only
const char* password = "88556437";     // enter ssid password (case sensitiv)
char host[] = "bedroomlights.herokuapp.com"; //enter your Heroku domain name like "espiot.herokuapp.com" 
